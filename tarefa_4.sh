...
read NOME
echo -n "Qual é a sua Altura: "
read ALTURA 
echo -n "Qual é o seu Peso: "
read PESO
...
if [[ ($IMC-ge'17.01') ]] && [[ ($IMC-le'18.49') ]]
    then
    echo "Esta com desnutricao grau I, abaixo do peso."
    else
    echo "Desnutricao grau II"

        if [[ ($IMC-ge'18.05') ]] && [[ ($IMC-le'24.99') ]]
        then
        echo "Esta com o peso normal, dentro da média."
        else
        echo "Desnutricao grau II"
        fi
    fi
